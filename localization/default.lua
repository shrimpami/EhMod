return {
    descriptions={
        ...
        Joker={
            ...
            j_caino={
                name="Canio",
                text={
                    "This Eh gains {X:mult,C:white} X#1# {} Mult",
            ...
            j_invisible={
                ...
                text={
                    ...
                    "sell this card to",
                    "{C:attention}Duplicate{} a random Eh",
                    "{C:inactive}(Currently {C:attention}#2#{C:inactive}/#1#)",
                },
                unlock={
                    "Win a run without",
                    "ever having more",
                    "than {E:1,C:attention}4 Ehs{}",
                },
            },
            j_joker={
                name="Eh",
            ...
            j_lucky_cat={
                name="Maneki N{C:attention}Eh{}ko",
                text={
                    "This Eh gains {X:mult,C:white} X#1# {} Mult",
            ...
            j_madness={
                ...
                text={
                    ...
                    "and {C:attention}destroy{} a random Eh",
                    "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
                },
            },
            j_mail={
            ...
            j_riff_raff={
                ...
                text={
                    "When {C:attention}Blind{} is selected,",
                    "create {C:attention}#1# {C:blue}Common{C:attention} Ehs",
                    "{C:inactive}(Must have room)",
                },
            },
            j_ring_master={
                name="Showman",
                text={
                    "{C:attention}Eh{}, {C:tarot}Tarot{}, {C:planet}Planet{},",
            ...
            j_stencil={
                ...
                text={
                    ...
                    "empty {C:attention}Eh{} slot",
                    "{s:0.8}Eh Stencil included",
            ...
            j_swashbuckler={
                ...
                text={
                    "Adds the sell value",
                    "of all other owned",
                    "{C:attention}Ehs{} to Mult",
                    "{C:inactive}(Currently {C:mult}+#1#{C:inactive} Mult)",
                },
                unlock={
                    "Sell a total of",
                    "{C:attention,E:1}#1#{} Eh cards",
                    "{C:inactive}(#2#)",
                },
            },
            j_throwback={
        ...
        Other={
            ...
            p_buffoon_jumbo={
                ...
                text={
                    "Choose {C:attention}#1#{} of up to",
                    "{C:attention}#2#{C:joker} Eh{} cards",
                },
            },
            p_buffoon_mega={
        ...
        Stake={
            stake_black={
                name="Black Stake",
                text={
                    "Shop can have {C:attention}Eternal{} Ehs",
            ...
            stake_gold={
                name="Gold Stake",
                text={
                    "Shop can have {C:attention}Rental{} Ehs",
            ...
            stake_orange={
                name="Orange Stake",
                text={
                    "Shop can have {C:attention}Perishable{} Ehs",
        ...
        Tarot={
            ...
            c_temperance={
                ...
                text={
                    ...
                    "Ehs {C:inactive}(Max of {C:money}$#1#{C:inactive})",
                    "{C:inactive}(Currently {C:money}$#2#{C:inactive})",
                },
            },
            c_tower={
    ...
    misc={
        achievement_descriptions={
            ...
            completionist_plus_plus="Earn a Gold Sticker on every Eh",
            ...
            legendary="Discover a Legendary Eh",
        ...
        dictionary={
            ...
            k_money="Money",
            k_mult="Mult",
            k_no_other_jokers="No other Ehs!",
            ...
            ph_deck_preview_effective="Effective total due to Ehs, Blinds, and card enhancements",
        ...
        tutorial={
            ...
            s_3={
                ...
                "{C:attention}Ehs{} you can add to",
                "your run. Every {C:attention}Eh",
            ...
            sh_1={
                ...
                "them. {C:attention}Ehs{} trigger in",
        ...
        v_text={
            ...
            ch_c_no_shop_jokers={
                "Ehs no longer appear in the {C:attention}shop",
            },
            ch_c_none={
                "{C:inactive}None",
            },
            ch_c_set_eternal_ante={
                "When ante {C:attention}#1#{} boss is defeated, all Ehs become {C:attention}eternal",
            },
            ch_c_set_joker_slots_ante={
                "When ante {C:attention}#1#{} boss is defeated, set Eh slots to {C:attention}0",
            },
            ch_c_set_seed={
